...
#[cfg_attr(feature = "offline", derive(serde::Serialize, serde::Deserialize))]
pub struct RqliteTypeInfo(pub(crate) DataType);
...
impl TypeInfo for RqliteTypeInfo {
...
// #[cfg(feature = "any")]
// impl From<RqliteTypeInfo> for crate::any::AnyTypeInfo {
//     #[inline]
//     fn from(ty: RqliteTypeInfo) -> Self {
//         crate::any::AnyTypeInfo(crate::any::type_info::AnyTypeInfoKind::Rqlite(ty))
//     }
// }
